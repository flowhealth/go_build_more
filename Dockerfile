...
RUN echo run this container with: java -Djava.library.path=./DynamoDBLocal_lib -jar DynamoDBLocal.jar -port 8091 -inMemory
## up to this point, it's just a go_build_tools + local dynamodb
